...
def generate_summary_report(model_metadata, eval_results):
    ...
    summary_df = pd.DataFrame({
        ...
        "Validation": [
            ...
            model_metadata.get("precision", "N/A"),
            model_metadata.get("recall", "N/A"),
    ...
    print(f"Test Set Size: {model_metadata.get('test_samples', eval_results.get('sample_count', 'N/A'))} samples")
    print(f"Training Set Size: {model_metadata.get('training_samples', 'N/A')} samples")
    print(f"Validation Set Size: {model_metadata.get('validation_samples', 'N/A')} samples")
